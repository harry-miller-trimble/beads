...
// MCPClient is a minimal JSON-RPC 2.0 client for the tracker driver protocol.
// It communicates with an external driver subprocess over stdin/stdout.
// Used by MCPAdapter to bridge the IssueTracker interface to external processes.
