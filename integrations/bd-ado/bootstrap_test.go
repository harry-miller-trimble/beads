...
func TestFindMatch_ExternalRef(t *testing.T) {
	...
	adoItem := &TrackerIssue{
		ID:    "42",
		Title: "Fix login bug",
		URL:   "https://dev.azure.com/org/proj/_workitems/edit/42",
	}
	localIssues := []*BeadsIssue{
		{ID: "bd-1", Title: "Unrelated", ExternalRef: "https://other.com/1"},
		{ID: "bd-2", Title: "Fix login bug", ExternalRef: "https://dev.azure.com/org/proj/_workitems/edit/42"},
	}
...
func TestFindMatch_HeuristicExactMatch(t *testing.T) {
	...
	localIssues := []*BeadsIssue{
		{ID: "bd-10", Title: "Fix login bug", IssueType: TypeBug, CreatedAt: now.Add(2 * time.Hour)},
	}
...
func TestFindMatch_HeuristicDisabled(t *testing.T) {
	...
	localIssues := []*BeadsIssue{
		{ID: "bd-10", Title: "Fix login bug", IssueType: TypeBug, CreatedAt: now},
	}
...
func TestFindMatch_HeuristicTitleMismatch(t *testing.T) {
	...
	localIssues := []*BeadsIssue{
		{ID: "bd-10", Title: "Fix logout bug", IssueType: TypeBug, CreatedAt: now},
	}
...
func TestFindMatch_HeuristicTypeMismatch(t *testing.T) {
	...
	localIssues := []*BeadsIssue{
		{ID: "bd-10", Title: "Fix login bug", IssueType: TypeFeature, CreatedAt: now},
	}
...
func TestFindMatch_HeuristicTimeOutsideWindow(t *testing.T) {
	...
	localIssues := []*BeadsIssue{
		{ID: "bd-10", Title: "Fix login bug", IssueType: TypeBug, CreatedAt: now.Add(25 * time.Hour)},
	}
...
func TestFindMatch_HeuristicMultipleCandidates(t *testing.T) {
	...
	localIssues := []*BeadsIssue{
		{ID: "bd-10", Title: "Fix login bug", IssueType: TypeBug, CreatedAt: now.Add(1 * time.Hour)},
		{ID: "bd-11", Title: "Fix login bug", IssueType: TypeBug, CreatedAt: now.Add(2 * time.Hour)},
	}
...
func TestFindMatch_NoMatch(t *testing.T) {
	...
	localIssues := []*BeadsIssue{
		{ID: "bd-1", Title: "Totally different issue", IssueType: TypeTask},
	}
	...
	localIssues := []*BeadsIssue{
		{
			ID:          "bd-99",
			Title:       "Fix login bug",
			ExternalRef: "https://dev.azure.com/org/proj/_workitems/edit/42",
			IssueType:   TypeBug,
			CreatedAt:   now,
		},
	}
...
func TestFindMatch_EmptyLocalIssues(t *testing.T) {
	...
	result = m.FindMatch(adoItem, []*BeadsIssue{})
	if result.Matched {
