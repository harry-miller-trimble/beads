...
func ExtractLinkDeps(workItem *WorkItem) []DependencyInfo {
...
func (r *LinkResolver) PullLinks(workItem *WorkItem) []DependencyInfo {
...
func (r *LinkResolver) PushLinks(ctx context.Context, workItemID int, currentRelations []WorkItemRelation, desiredDeps []DependencyInfo) []error {
	// Build desired link set.
	desired := make(map[adoLinkKey]DependencyInfo)
